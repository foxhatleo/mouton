...
import { amber } from "material-colors-ts";
...
const WorkListView: React.ComponentType = () => (
	<WorkPage part={"ListView"} color={amber} />
);
...
export async function generateMetadata(ctx: GenerateMetadataParams) {
	...
	const t = await getTranslations({ locale, namespace: "ListView" });
...
export const viewport: Viewport = {
	themeColor: [
		{ media: "(prefers-color-scheme: light)", color: amber[500] },
		{ media: "(prefers-color-scheme: dark)", color: amber[700] },
	],
};
