...
declare global {
	interface Window {
		__mouton_console_printed?: boolean;
	}
}

export default function useConsole() {
	if (typeof window === "undefined" || window.__mouton_console_printed) {
		return;
	}
	window.__mouton_console_printed = true;
